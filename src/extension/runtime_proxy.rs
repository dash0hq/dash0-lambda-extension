...
async fn validate_and_mangle_next_event(
    ...
    let (http_request_attributes, http_span_name) =
        crate::otlp::span_mutations::extract_http_request_data_from_raw_event(&body_bytes);
    ...
    invocation_entry::update(&_aws_request_id, |entry| {
        ...
        entry.http_request_attributes = http_request_attributes;
        entry.http_span_name = http_span_name;
