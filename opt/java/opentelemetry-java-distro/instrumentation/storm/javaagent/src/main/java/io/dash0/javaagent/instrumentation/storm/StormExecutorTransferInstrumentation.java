...
import static io.dash0.javaagent.instrumentation.storm.StormSingleton.stormExecutorInstrumenter;
...
public class StormExecutorTransferInstrumentation implements TypeInstrumentation {
  ...
  public void transform(TypeTransformer typeTransformer) {
    typeTransformer.applyAdviceToMethod(
        named("tryTransfer"),
        io.dash0.javaagent.instrumentation.storm.StormExecutorTransferInstrumentation.class
                .getName()
