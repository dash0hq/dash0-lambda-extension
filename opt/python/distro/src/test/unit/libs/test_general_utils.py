...
def test_dash0_safe_wrapper_happy_flow():
    @dash0_safe_wrapper()
    def my_func():
        return 1
...
def test_dash0_safe_wrapper_exception():
    @dash0_safe_wrapper()
    def my_func():
...
def test_dash0_safe_wrapper_exception_default_value():
    @dash0_safe_wrapper(default_return_value=1)
    def my_func():
        raise Exception("test")
